                                ...
                                <Col md="7">
                                    <div className="product-information">
                                        ...
                                        <div className="product-desc">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam et
                                                dolorem nostrum quos placeat. Quibusdam necessitatibus adipisci
                                                dignissimos autem voluptate, dicta ullam, assumenda qui, corporis ut
                                                vero neque sapiente possimus.</p>
                                        </div>
                                        <div className="product-stock">
                                            <p>Availability : <span className="stock">In Stock</span> <span
                                                className="stock-num">(09 Available)</span></p>
                                        </div>
                                        <div className="product-color">
                                            <ul className="list-unstyled list-inline">
                                                ...
                                                <li className="list-inline-item">
                                                    ...
                                                    <label htmlFor="color-1"><span><i
                                                        className="las la-check"></i></span></label>
                                                </li>
                                                <li className="list-inline-item">
                                                    <input type="radio" id="color-2" name="color" value="color-2"/>
                                                    <label htmlFor="color-2"><span><i
                                                        className="las la-check"></i></span></label>
                                                </li>
                                                <li className="list-inline-item">
                                                    <input type="radio" id="color-3" name="color" value="color-3"/>
                                                    <label htmlFor="color-3"><span><i
                                                        className="las la-check"></i></span></label>
                                                </li>
                                                <li className="list-inline-item">
                                                    <input type="radio" id="color-4" name="color" value="color-4"/>
                                                    <label htmlFor="color-4"><span><i
                                                        className="las la-check"></i></span></label>
                                                </li>
                                                <li className="list-inline-item">
                                                    <input type="radio" id="color-5" name="color" value="color-5"/>
                                                    <label htmlFor="color-5"><span><i
                                                        className="las la-check"></i></span></label>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="product-cart-wh-com-btn">
                                            <Link to={process.env.PUBLIC_URL + "/product-details"} className="cart-btn">Add
                                                To Cart</Link>
                                            <Link to={process.env.PUBLIC_URL + "/product-details"}
                                                  className="wishlist-btn"><i className="far fa-heart"></i></Link>
                                            <Link to={process.env.PUBLIC_URL + "/product-details"}
                                                  className="compare-btn"><i className="fas fa-random"></i></Link>
                                        </div>
                                    </div>
                                </Col>
                                            ...
                                            <Tab.Content>
                                                <Tab.Pane eventKey="description" className="description-tab">
                                                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                        Assumenda optio sequi suscipit et modi! Corporis obcaecati rerum
                                                        et, explicabo inventore, aliquid, odit modi harum libero culpa
                                                        distinctio. Nemo, aliquid dignissimos. Lorem ipsum dolor sit
                                                        amet consectetur adipisicing elit. Optio earum praesentium
                                                        impedit enim voluptate ducimus, saepe autem. Lorem ipsum dolor
                                                        sit, amet consectetur adipisicing accusantium quam eius
                                                        dignissimos quaerat voluptatem excepturi aliquid dolor ducimus.
                                                        Illo porro maiores fuga dignissimos temporibus odio nulla nobis
                                                        nemo. Lorem ipsum dolor sit amet consectetur adipisicing
                                                        elit.<br/><br/>Lorem ipsum dolor sit amet consectetur
                                                        adipisicing elit. Facere nesciunt harum facilis odit inventore
                                                        molestias qui asperiores recusandae architecto mollitia
                                                        provident ipsa unde, praesentium impedit enim voluptate ducimus,
                                                        saepe autem. Lorem ipsum dolor sit, amet consectetur adipisicing
                                                        elit. Optio earum accusantium quam eius dignissimos quaerat
                                                        voluptatem excepturi aliquid dolor ducimus.<br/><br/>Lorem ipsum
                                                        dolor sit amet consectetur adipisicing elit. Facere nesciunt
                                                        harum facilis odit inventore molestias qui asperiores recusandae
                                                        architecto mollitia provident ipsa unde, praesentium impedit
                                                        enim voluptate ducimus, saepe autem met adipisicing nesciunt
                                                        facilis.</p>
                                                </Tab.Pane>
                                                    ...
                                                    <div className="review-comments">
                                                        <div className="comment-box d-flex">
                                                            ...
                                                            <div className="comment-content">
                                                                ...
                                                                <div
                                                                    className="date-rating d-flex justify-content-between">
                                                                    <p>Mar 26, 2020</p>
                                                                    <ul className="list-unstyled list-inline">
                                                                        <li className="list-inline-item"><i
                                                                ...
                                                                <div className="comment-desc">
                                                                    <p>Lorem ipsum dolor sit amet consectetur
                                                                        ...
                                                                        laborum quas placeat perspiciatis saepe.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="comment-box d-flex">
