                                ...
                                <Col lg="8" md="12">
                                    <div className="product-list table-responsive">
                                        <Table className="table-bordered">
                                            ...
                                            <tbody>
                                            <tr>
                                                <td className="product-remove"><a href={process.env.PUBLIC_URL + "/"}><i
                                                    className="las la-trash"></i></a></td>
                                                <td className="product-thumbnail"><a
                                                    href={process.env.PUBLIC_URL + "/"}><img
                                                    src={process.env.PUBLIC_URL + `/assets/images/product-01.jpg`}
                                                    alt=""/></a></td>
                                                <td className="product-title"><a href={process.env.PUBLIC_URL + "/"}>Product
                                                    Title Here ...</a></td>
                                                <td className="product-price"><span className="amount">$49.00</span>
                                                </td>
                                                <td className="product-quantity">
                                                    <input type="number" className="form-control" defaultValue="1"/>
                                                </td>
                                                <td className="product-subtotal"><span
                                                    className="subtotal">$49.00</span></td>
                                            </tr>
                                            <tr>
                                                <td className="product-remove"><a href={process.env.PUBLIC_URL + "/"}><i
                                                    className="las la-trash"></i></a></td>
                                                <td className="product-thumbnail"><a
                                                    href={process.env.PUBLIC_URL + "/"}><img
                                                    src={process.env.PUBLIC_URL + `/assets/images/product-02.jpg`}
                                                    alt=""/></a></td>
                                                <td className="product-title"><a href={process.env.PUBLIC_URL + "/"}>Product
                                                    Title Here ...</a></td>
                                                <td className="product-price"><span className="amount">$39.00</span>
                                                </td>
                                                <td className="product-quantity">
                                                    <input type="number" className="form-control" defaultValue="1"/>
                                                </td>
                                                <td className="product-subtotal"><span
                                                    className="subtotal">$39.00</span></td>
                                            </tr>
                                            <tr>
                                                <td className="product-remove"><a href={process.env.PUBLIC_URL + "/"}><i
                                                    className="las la-trash"></i></a></td>
                                                <td className="product-thumbnail"><a
                                                    href={process.env.PUBLIC_URL + "/"}><img
                                                    src={process.env.PUBLIC_URL + `/assets/images/product-03.jpg`}
                                                    alt=""/></a></td>
                                                <td className="product-title"><a href={process.env.PUBLIC_URL + "/"}>Product
                                                    Title Here ...</a></td>
                                                <td className="product-price"><span className="amount">$59.00</span>
                                                </td>
                                                <td className="product-quantity">
                                                    <input type="number" className="form-control" defaultValue="1"/>
                                                </td>
                                                <td className="product-subtotal"><span
                                                    className="subtotal">$59.00</span></td>
                                            </tr>
                                            </tbody>
                                        </Table>
                                        <div className="actions d-flex justify-content-between">
                                            ...
                                            <div className="update-cart">
                                                <a className="update-btn" href={process.env.PUBLIC_URL + "/"}>Update
                                                    cart</a>
                                            </div>
                                        </div>
                                    </div>
